...
<div class="container py-4 py-xl-5">
    ...
    <div class="row mb-4 mb-lg-5 pt-5">
      <div class="col-md-12 col-lg-12 col-xl-12 text-center mx-auto" data-aos="zoom-in" data-aos-duration="250"
        data-aos-delay="250">
        <h2><strong><span style="color: rgb(34, 177, 76);">About The Developer</span></strong></h2>
        <p class="w-lg-50"><strong><em><span style="color: rgb(26, 26, 26);">This project was developed independently by Ayhm Rahhal — a passionate full-stack web developer dedicated to creating practical and user-friendly web solutions. With a deep interest in both technology and sports, I built this platform to make sports field reservations easier and more accessible for everyone.</span></em></strong></p>
      </div>
    </div>
    <div class="row gy-4 row-cols-2 row-cols-md-4 align-items-center justify-content-center">
